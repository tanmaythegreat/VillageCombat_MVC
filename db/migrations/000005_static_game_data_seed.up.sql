...
-- ── Cannon ────────────────────────────────────────────────────────────────────
INSERT INTO upgrade_costs (building_id, upgrade_to_level, gold_required, elixir_required, or_gem_required, time_required_seconds, town_hall_level_required)
SELECT building_id, 1,           2000,           0,          2,       18, 1 FROM building_configs_base WHERE name = 'Cannon'
UNION ALL
...
-- ── Archer Tower ──────────────────────────────────────────────────────────────
INSERT INTO upgrade_costs (building_id, upgrade_to_level, gold_required, elixir_required, or_gem_required, time_required_seconds, town_hall_level_required)
SELECT building_id, 1,           3000,           0,          2,       36, 1 FROM building_configs_base WHERE name = 'Archer Tower'
UNION ALL
...
-- ── Air Defense ───────────────────────────────────────────────────────────────
INSERT INTO upgrade_costs (building_id, upgrade_to_level, gold_required, elixir_required, or_gem_required, time_required_seconds, town_hall_level_required)
SELECT building_id, 1,           10000,           0,          2,       72, 2 FROM building_configs_base WHERE name = 'Air Defense'
UNION ALL
...
SELECT building_id, 1,           500,           2,          9, 1 FROM building_configs_base WHERE name = 'Gold Mine'
UNION ALL
...
-- ── Gold Storage ──────────────────────────────────────────────────────────────
INSERT INTO upgrade_costs (building_id, upgrade_to_level, gold_required, or_gem_required, time_required_seconds, town_hall_level_required)
SELECT building_id, 1,           1000,           2,          18, 1 FROM building_configs_base WHERE name = 'Gold Storage'
UNION ALL
...
SELECT building_id, 1,           500,           2,          9, 1 FROM building_configs_base WHERE name = 'Elixir Collector'
UNION ALL
...
-- ── Elixir Storage ────────────────────────────────────────────────────────────
INSERT INTO upgrade_costs (building_id, upgrade_to_level, elixir_required, or_gem_required, time_required_seconds, town_hall_level_required)
SELECT building_id, 1,           1000,           2,          18, 1 FROM building_configs_base WHERE name = 'Elixir Storage'
UNION ALL
...
SELECT building_id, 1,           30,           2,          72, 5 FROM building_configs_base WHERE name = 'Dark Elixir Drill'
UNION ALL
...
INSERT INTO upgrade_costs (building_id, upgrade_to_level, dark_elixir_required, or_gem_required, time_required_seconds, town_hall_level_required)
SELECT building_id, 1,           30,           2,          72, 5 FROM building_configs_base WHERE name = 'Dark Elixir Storage'
UNION ALL
...
-- ── Barracks (elixir) ─────────────────────────────────────────────────────────
INSERT INTO upgrade_costs (building_id, upgrade_to_level, elixir_required, or_gem_required, time_required_seconds, town_hall_level_required)
SELECT building_id, 1,           1000,           2,          18, 1 FROM building_configs_base WHERE name = 'Barracks'
UNION ALL
